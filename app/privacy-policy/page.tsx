  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-5xl font-bold text-primary-dark mb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">2. Information We Collect</h2>
            <h3 className="text-2xl font-semibold text-primary-dark mb-3">2.1 Personal Information</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-2xl font-semibold text-primary-dark mb-3">2.2 Automatically Collected Information</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">3. How We Use Your Information</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">4. Information Sharing and Disclosure</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">5. Data Security</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">6. Your Rights</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">7. Data Retention</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">8. Children's Privacy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">9. Changes to This Privacy Policy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-primary-dark mb-4">10. Contact Us</h2>
            <p className="text-gray-700 leading-relaxed">
